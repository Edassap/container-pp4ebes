...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pp4ebes.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pp4ebes.containers.anotherwebservice.com/
...
```
git clone git@github.com:Edassap/container-pp4ebes.git
cd container-pp4ebes
```
...
```
docker attach container-pp4ebes
```
